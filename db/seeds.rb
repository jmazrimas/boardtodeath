...
u4 = User.create(username: "dylanc" , email: "dylanc@email.com", password: "password", image: "https://anenglishwomaninsalem.files.wordpress.com/2012/01/letter-homer-sour.jpg")
